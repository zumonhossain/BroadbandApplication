                ...
                <div class="card-body">
                    <form action="{{ route('division_insert_form') }}" method="POST" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input type="text" name="division_name" class="form-control" placeholder="Division Name" value="{{ old('division_name') }}">
                                @error('division_name')
                    ...
                    <table class="table table-bordered table-striped table-hover custom_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="btn-info edit-icon" href="{{ route('division_edit_form',$division->division_id) }}"><i class="mdi mdi-table-edit"></i></a>
                                    <a class="btn-danger delete-icon" id="softDelete" data-toggle="modal" data-target="#softDelModal" data-id="{{ $division->division_id }}" href="#"><i class="mdi mdi-delete"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
