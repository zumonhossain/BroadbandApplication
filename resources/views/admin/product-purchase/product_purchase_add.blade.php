                    ...
                    <table class="table table-bordered table-striped table-hover custom_table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $productPurchase->month->month_name_en }}</td>
                                <td>
                                    <a class="btn-info edit-icon" href="{{ route('product_purchase_edit_form',$productPurchase->product_purchase_id ) }}"><i class="mdi mdi-table-edit"></i></a>
                                    <a class="btn-danger delete-icon" id="softDelete" data-toggle="modal" data-target="#softDelModal" data-id="{{ $productPurchase->product_purchase_id  }}" href="#"><i class="mdi mdi-delete"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
